  ...
  return (
    <div className='w-full pb-20'>
      <div className='layout'>
        ...
        <motion.div className='shadow w-full rounded-xl md:rounded-2xl xl:rounded-3xl'
          initial={{ y: 50, opacity: 0 }}
          whileInView={{ y: 0, opacity: 1 }}
          transition={{ duration: 0.3 }}
        >
          ...
          <motion.div className='w-full grid md:grid-cols-2 xl:grid-cols-3 rounded-b-xl md:rounded-b-2xl xl:rounded-b-3xl'
